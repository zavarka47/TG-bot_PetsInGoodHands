...
@Component
public class HouseForAdultPetHandler  implements TelegramHandler {

    private final Messages messages;
    private final AnimalService animalService;
    private final ShelterService shelterService;
    private Pattern pattern = Pattern.compile("0.0.5.2.1.\\d+");


    public HouseForAdultPetHandler(Messages messages, AnimalService animalService, ShelterService shelterService) {
