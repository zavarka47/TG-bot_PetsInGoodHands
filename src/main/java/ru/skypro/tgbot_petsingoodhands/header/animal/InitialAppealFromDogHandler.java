...
@Component
public class InitialAppealFromDogHandler implements TelegramHandler {

    private final Messages messages;
    private final AnimalService animalService;
    private final ShelterService shelterService;
    private Pattern pattern = Pattern.compile("0.0.7.2.1.\\d+");

    public InitialAppealFromDogHandler(Messages messages, AnimalService animalService, ShelterService shelterService) {
    ...
    public void handleUpdate(Update update) {
        ...
        messages.sendSimpleMessage(chatId, animalService.getById(animalId).getInitialAppealFromDogHandler());
    }
}
