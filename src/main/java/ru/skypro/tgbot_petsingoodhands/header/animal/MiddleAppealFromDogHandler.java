...
@Component
public class MiddleAppealFromDogHandler implements TelegramHandler {

    private final Messages messages;
    private final AnimalService animalService;
    private final ShelterService shelterService;
    private Pattern pattern = Pattern.compile("0.0.8.2.1.\\d+");

    public MiddleAppealFromDogHandler(Messages messages, AnimalService animalService, ShelterService shelterService) {
    ...
    public void handleUpdate(Update update) {
        ...
        messages.sendSimpleMessage(chatId, animalService.getById(animalId).getMiddleAppealFromDogHandler());
    }
}
