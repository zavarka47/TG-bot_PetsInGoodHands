...
public class HouseForBabyPetHandlerTest {
    @Mock
    ...
    @InjectMocks
    private HouseForBabyPetHandler houseForBabyPetHandler;
    private static Update update;
    Pattern pattern = Pattern.compile("0.0.4.2.1.\\d+");
    ...
    public static void initializationResource() throws URISyntaxException, IOException {
        ...
        update = BotUtils.fromJson(callbackQuery.replace("%text%", "0.0.4.2.1.1"), Update.class);
    }
    ...
    public void handleUpdateTest() {
        ...
        when(animal.getHouseForBabyPet()).thenReturn("Рекомендаций по обустройству дома для котенка");
        houseForBabyPetHandler.handleUpdate(update);
        ...
        Assertions.assertEquals(text, "Рекомендаций по обустройству дома для котенка");
