...
public class MiddleAppealFromDogHandlerTest {
    @Mock
    ...
    @InjectMocks
    private MiddleAppealFromDogHandler middleAppealFromDogHandler;
    private static Update update;
    Pattern pattern = Pattern.compile("0.0.8.2.1.\\d+");
    ...
    public static void initializationResource() throws URISyntaxException, IOException {
        ...
        update = BotUtils.fromJson(callbackQuery.replace("%text%", "0.0.8.2.1.1"), Update.class);
    }
    ...
    public void handleUpdateTest() {
        ...
        when(animal.getMiddleAppealFromDogHandler()).thenReturn("Cоветы кинолога по дрессировке");
        middleAppealFromDogHandler.handleUpdate(update);
        ...
        Assertions.assertEquals(text, "Cоветы кинолога по дрессировке");
