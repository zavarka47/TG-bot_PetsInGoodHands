...
public class HouseForIllPetHandlerTest {
    @Mock
    ...
    @InjectMocks
    private HouseForIllPetHandler houseForIllPetHandler;
    private static Update update;
    Pattern pattern = Pattern.compile("0.0.6.2.1.\\d+");
    ...
    public static void initializationResource() throws URISyntaxException, IOException {
        ...
        update = BotUtils.fromJson(callbackQuery.replace("%text%", "0.0.6.2.1.1"), Update.class);
    }
    ...
    public void handleUpdateTest() {
        ...
        when(animal.getHouseForIllPet()).thenReturn("Рекомендаций по обустройству дома для слепого кота");
        houseForIllPetHandler.handleUpdate(update);
        ...
        Assertions.assertEquals(text, "Рекомендаций по обустройству дома для слепого кота");
