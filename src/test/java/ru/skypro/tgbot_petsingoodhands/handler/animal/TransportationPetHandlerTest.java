...
public class TransportationPetHandlerTest {
    @Mock
    ...
    @InjectMocks
    private TransportationPetHandler transportationPetHandler;
    private static Update update;
    Pattern pattern = Pattern.compile("0.0.3.2.1.\\d+");
    ...
    public static void initializationResource() throws URISyntaxException, IOException {
        ...
        update = BotUtils.fromJson(callbackQuery.replace("%text%", "0.0.3.2.1.1"), Update.class);
    }
    ...
    public void handleUpdateTest() {
        ...
        when(animal.getTransportation()).thenReturn("Рекомендаций по транспортировке кота");
        transportationPetHandler.handleUpdate(update);
        ...
        Assertions.assertEquals(text, "Рекомендаций по транспортировке кота");
